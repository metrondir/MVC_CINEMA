    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 188m, 1, new DateTime(2024, 5, 23, 7, 53, 27, 168, DateTimeKind.Utc).AddTicks(5554), 368m },
                    { 2, 165m, 2, new DateTime(2024, 5, 18, 16, 8, 27, 168, DateTimeKind.Utc).AddTicks(5593), 366m },
                    { 3, 176m, 1, new DateTime(2024, 5, 28, 2, 8, 27, 168, DateTimeKind.Utc).AddTicks(5619), 318m },
                    { 4, 107m, 1, new DateTime(2024, 5, 30, 4, 57, 27, 168, DateTimeKind.Utc).AddTicks(5643), 346m },
                    { 5, 114m, 1, new DateTime(2024, 5, 22, 23, 37, 27, 168, DateTimeKind.Utc).AddTicks(5668), 398m },
                    { 6, 144m, 1, new DateTime(2024, 5, 19, 21, 42, 27, 168, DateTimeKind.Utc).AddTicks(5692), 306m },
                    { 7, 131m, 2, new DateTime(2024, 5, 22, 23, 35, 27, 168, DateTimeKind.Utc).AddTicks(5718), 290m },
                    { 8, 107m, 1, new DateTime(2024, 5, 20, 7, 36, 27, 168, DateTimeKind.Utc).AddTicks(5765), 290m },
                    { 9, 173m, 1, new DateTime(2024, 6, 1, 9, 27, 27, 168, DateTimeKind.Utc).AddTicks(5790), 287m },
                    { 10, 181m, 1, new DateTime(2024, 5, 25, 1, 39, 27, 168, DateTimeKind.Utc).AddTicks(5813), 349m },
                    { 11, 161m, 1, new DateTime(2024, 5, 28, 9, 24, 27, 168, DateTimeKind.Utc).AddTicks(5838), 252m },
                    { 12, 137m, 1, new DateTime(2024, 5, 26, 13, 59, 27, 168, DateTimeKind.Utc).AddTicks(5860), 258m },
                    { 13, 122m, 2, new DateTime(2024, 5, 27, 7, 52, 27, 168, DateTimeKind.Utc).AddTicks(5884), 396m },
                    { 14, 192m, 1, new DateTime(2024, 6, 4, 9, 17, 27, 168, DateTimeKind.Utc).AddTicks(5907), 334m },
                    { 15, 184m, 2, new DateTime(2024, 5, 30, 15, 32, 27, 168, DateTimeKind.Utc).AddTicks(5931), 337m },
                    { 16, 113m, 2, new DateTime(2024, 5, 25, 13, 40, 27, 168, DateTimeKind.Utc).AddTicks(5953), 287m },
                    { 17, 134m, 1, new DateTime(2024, 5, 23, 14, 7, 27, 168, DateTimeKind.Utc).AddTicks(5977), 354m },
                    { 18, 118m, 2, new DateTime(2024, 6, 5, 19, 5, 27, 168, DateTimeKind.Utc).AddTicks(6016), 258m },
                    { 19, 161m, 2, new DateTime(2024, 6, 5, 9, 12, 27, 168, DateTimeKind.Utc).AddTicks(6040), 309m },
                    { 20, 136m, 1, new DateTime(2024, 5, 20, 17, 44, 27, 168, DateTimeKind.Utc).AddTicks(6062), 335m }
                });
