...
namespace SoftServeCinema.Core.Validators.UserValidators
{
    public class UserRegisterValidatorDTO : AbstractValidator<UserRegisterDTO>
    {
        private readonly IUserService _userService;

        public UserRegisterValidatorDTO(IUserService userService)
        {
